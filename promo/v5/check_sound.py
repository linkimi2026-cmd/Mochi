...
assert abs(float(p['format']['duration'])-80)<.001
...
result={'duration':80,'sampleRate':rate,'channels':channels,'peakDbFS':round(20*math.log10(peak),2),'musicLooped':False,'cueWindows':values}
