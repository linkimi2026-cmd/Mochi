...
| 场景 | 正确行为 | 理由 |
|---|---|---|
| 审批通道**缺失** | **fail-open**（不收窄工具面） | 没有通道就没有人能批准；收窄 = 永久瘫痪 |
...
| 层级 | 文件 | 管辖 |
|---|---|---|
| **L0-A** | `docs/tasks/MOCHI-URGENT-REPLAN-2026-09-11.md` | 排期与交付判据 |
| **L0-B** | `docs/build-standard.md` | 打包/出包唯一路径 |
| **L0-C** | `docs/DOC-AUTHORITY.md` | 文档治理裁决书 |
| **L1** | `Mochi-总体方案.md` v2.0 | 产品设计 |
| **L2** | **源码** | 当前实现事实（**L2 永远赢**） |
| **L3** | `docs/tasks/MOCHI-*.md` | 单工单 |
| **L4** | `plan/`、`foundation/`、`Mochi-方案总纲.md`、`artifacts/` | 历史档案，**不作为实现依据** |

**冲突消解顺序**：L0 > L1 > L3 > L4；**与 L2 冲突时以源码为准**。

### 17.2 三条截止日期（勿混）

| 日期 | 含义 | 状态 |
|---|---|---|
| **2026-09-11** | Mochi 出包 / 演示 | ✅ 已交付（`release/2026-09-09`、`release/2026-09-10`） |
| **2026-09-30** | 嘉行联参赛材料 | 🟡 进行中 |
